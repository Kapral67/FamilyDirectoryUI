...
let setId, caller, setCaller, setData, setIsEditing, editedData;
                                ...
                                <Grid item>
                                    <FormControl fullWidth>
                                        <TextField
                                            ...
                                            onChange={(event) => editedData['middleName'] = event.target.value}
                                        />
                                    </FormControl>
                                </Grid>
                                <Grid item>
                                    <FormControl fullWidth>
                                        <TextField
                                            ...
                                            onChange={(event) => editedData['lastName'] = event.target.value}
                                        />
                                    </FormControl>
                                </Grid>
                                <Grid item>
